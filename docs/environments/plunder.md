...
| **Import** | `gymnasium.make("procgen:procgen-plunder-v0")` |
...
# Single environment
env = gymnasium.make("procgen:procgen-plunder-v0")

# Vectorized
env = gymnasium.make_vec("procgen:procgen-plunder-v0", num_envs=16)
```
