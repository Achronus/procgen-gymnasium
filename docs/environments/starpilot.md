...
| **Import** | `gymnasium.make("procgen:procgen-starpilot-v0")` |
...
# Single environment
env = gymnasium.make("procgen:procgen-starpilot-v0")

# Vectorized
env = gymnasium.make_vec("procgen:procgen-starpilot-v0", num_envs=16)
```
