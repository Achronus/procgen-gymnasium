...
| **Import** | `gymnasium.make("procgen:procgen-bossfight-v0")` |
...
# Single environment
env = gymnasium.make("procgen:procgen-bossfight-v0")

# Vectorized
env = gymnasium.make_vec("procgen:procgen-bossfight-v0", num_envs=16)
```
