...
| **Import** | `gymnasium.make("procgen:procgen-dodgeball-v0")` |
...
# Single environment
env = gymnasium.make("procgen:procgen-dodgeball-v0")

# Vectorized
env = gymnasium.make_vec("procgen:procgen-dodgeball-v0", num_envs=16)
```
