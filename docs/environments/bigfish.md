...
| **Import** | `gymnasium.make("procgen:procgen-bigfish-v0")` |
...
# Single environment
env = gymnasium.make("procgen:procgen-bigfish-v0")

# Vectorized
env = gymnasium.make_vec("procgen:procgen-bigfish-v0", num_envs=16)
```
