...
| **Import** | `gymnasium.make("procgen:procgen-leaper-v0")` |
...
# Single environment
env = gymnasium.make("procgen:procgen-leaper-v0")

# Vectorized
env = gymnasium.make_vec("procgen:procgen-leaper-v0", num_envs=16)
```
