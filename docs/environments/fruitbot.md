...
| **Import** | `gymnasium.make("procgen:procgen-fruitbot-v0")` |
...
# Single environment
env = gymnasium.make("procgen:procgen-fruitbot-v0")

# Vectorized
env = gymnasium.make_vec("procgen:procgen-fruitbot-v0", num_envs=16)
```
